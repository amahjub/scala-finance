error id: file:///C:/Users/ADMB/scala-finance/BondPricer.scala:scala/collection/IterableOps#zipWithIndex().
file:///C:/Users/ADMB/scala-finance/BondPricer.scala
empty definition using pc, found symbol in pc: scala/collection/IterableOps#zipWithIndex().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -cashflows/zipWithIndex.
	 -scala/Predef.cashflows.zipWithIndex.
offset: 836
...
def duration(face: Double, coupon: Double, maturity: Int, rate: Double): Double =
 ...
 val weightedSum = cashflows.zipW@@ithIndex.map: (cf, i) =>
